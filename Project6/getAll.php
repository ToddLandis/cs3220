...
for ($i = 0; $i < count($plans); $i++) {
        ...
        while ($stmt->fetch()) {
                ...
                if ($fieldE == "Fall") {
                        $plan_courses[$fieldB] = ['DBID'=>$fieldA, 'id'=>$fieldB, 'name'=>$fieldC, 'year'=>$fieldD, 'term'=>$fieldE];
                }
                else {
                        $plan_courses[$fieldB] = ['DBID'=>$fieldA, 'id'=>$fieldB, 'name'=>$fieldC, 'year'=>$fieldD-1, 'term'=>$fieldE];
                }
        }
