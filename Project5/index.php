        ...
        <body>
                <div id="main">
                        <div id="header">
                                <div id="left">
                                        <div class="menu">
                                                <button onclick="linksDropdownFunction()" class="headerbtn modebtn" id="linksdropbtn"><img src="./img/gear.png" width="25px" height= "25px"></button>
                                                <div id="linksDropdown" class="dropdown-content">
                                                        <a href="http://csweb.cedarville.edu">People's Choice Awards</a>
                                                        <a href="http://csweb.cedarville.edu/~carpent/cs3220.html">Ryan's Homepage</a>
                                                        <a href="http://csweb.cedarville.edu/~tilandis/cs3220.html">Todd's Homepage</a>
                                                        <a href="http://csweb.cedarville.edu/~hearne/cs3220.html">Joshua's Homepage</a>
                                                        <a onclick="darkModeFunction()">Dark Mode</a>
                                                </div>
                                        </div>
                                </div>
                                <div id="title">
                        ...
                        <div id="infobar">
                                <div id="planinfo"></div>
                                <button class="infobtn" id="savebtn" onclick="newPlan()">New Plan</button>
                                <button class="infobtn" id="savebtn" onclick="revertPlan()">Revert Plan</button>
