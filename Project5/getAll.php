...
// requirements
$stmt = $mysqli->prepare("SELECT CHL_Course.Designator, CHL_Course.Title, CHL_Category.Name from CHL_Catalog_Courses,CHL_Category_Courses,CHL_Category,CHL_Requirements,CHL_Course 
